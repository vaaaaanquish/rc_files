...
let using_python = '/Users/shunsuke.kawai/.asdf/shims/python'
...
" ---------------- python ----------------
let PATH = expand(root_path . ".asdf/shims") . ":" . $PATH
if version < 600
  syntax clear
...
" ---------------- dein.vim --------------
set nocompatible
let s:dein_base = root_path . '.cache/dein'
let s:dein_src = root_path . '.cache/dein/repos/github.com/Shougo/dein.vim'
